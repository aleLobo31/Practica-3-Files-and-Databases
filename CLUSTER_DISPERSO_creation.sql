...
-- DROP CLUSTER IF EXISTS
DROP CLUSTER cl_places;

-- CREATE CLUSTER FOR EDITIONS
-- ----------------------------
CREATE CLUSTER cl_places(pub_place VARCHAR2(50))
...
-- EDITIONS table using the cluster
