...
DROP TABLE books;
DROP CLUSTER cl_editions_pubplace;
DROP CLUSTER cl_editions_publisher;
DROP CLUSTER cl_copies_condition;

-- CREATE HASH CLUSTERS
-- ---------------------
CREATE CLUSTER cl_editions_pubplace (
...
-- TABLE USING SECOND CLUSTER (publisher)
-- To test different cluster performance easily, you could redefine Editions to use either
-- cl_editions_pubplace or cl_editions_publisher as needed.
-- Just comment/uncomment the relevant CLUSTER line above.
...
CLUSTER cl_copies_condition(condition);
